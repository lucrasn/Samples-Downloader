...
void main() {
  group('Testes de DataTable do SamplesDownloader', () {
    ...
    testWidgets('Itens de arquivo são exibidos no DataTable', (WidgetTester tester) async {
      await tester.pumpWidget(const MyApp());
      ...
      expect(find.text('Lista de exercício de N1 (Revisão da Prova)- 2024-2 (respostas)'), findsOneWidget);
      expect(find.text('Planilha de notas Odontologia - 2024-2 - A'), findsOneWidget);
      expect(find.text('Planilha de notas Odontologia - 2024-2 - B'), findsOneWidget);
